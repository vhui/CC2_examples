...
int client(int x, int x_copy1, int x_copy2, int x_copy3, int x_copy4, int x_copy5, int x_copy6, int x_copy7, int x_copy8, int x_copy9, int x_copy10, int x_copy11, int x_copy12, int x_copy13, int x_copy14)
{
  ...
  else
  {
    if (x_copy12 < 0)
    {
      ret_copy12 = (-lib((-x_copy12) * 5)) / 5;
    }
    else
    {
      ret_copy12 = (lib((x_copy12 + 1) * 5) / 5) - 1;
    }
  ...
  else
  {
    if (x_copy13 < 0)
    {
      ret_copy13 = (-lib((-x_copy13) * 5)) / 5;
    }
    else
    {
      ret_copy13 = (lib((x_copy13 + 1) * 5) / 5) - 1;
    }
  ...
  else
  {
    if (x_copy14 < 0)
    {
      ret_copy14 = (-lib((-x_copy14) * 5)) / 5;
    }
    else
    {
      ret_copy14 = (lib((x_copy14 + 1) * 5) / 5) - 1;
    }
