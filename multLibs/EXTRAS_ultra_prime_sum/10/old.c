...
int client(int n, int n_copy1, int n_copy2, int n_copy3, int n_copy4, int n_copy5, int n_copy6, int n_copy7, int n_copy8, int n_copy9)
{
  ...
  return (((((((((lib(sum) == 0) + (lib(sum_copy1) == 0)) + (lib(sum_copy2) == 0)) + (lib(sum_copy3) == 0)) + (lib(sum_copy4) == 0)) + (lib(sum_copy5) == 0)) + (lib(sum_copy6) == 0)) + (lib(sum_copy7) == 0)) + (lib(sum_copy8) == 0)) + (lib(sum_copy9) == 0);
}
