...
{
  return (((((((((((((lib(x) + lib(x_copy1)) + lib(x_copy2)) + lib(x_copy3)) + lib(x_copy4)) + lib(x_copy5)) + lib(x_copy6)) + lib(x_copy7)) + lib(x_copy8)) + lib(x_copy9)) + lib(x_copy10)) + lib(x_copy11)) + lib(x_copy12)) + lib(x_copy13)) + lib(x_copy14);
}
