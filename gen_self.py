...
def main():
    ...
    if not useV2:
        ...
        if client1n.decl.type.args is not None and client2ncopy.decl.type.args is not None:
            client1n.decl.type.args.params.extend(client2ncopy.decl.type.args.params)
        elif client2ncopy.decl.type.args is not None:
            client1n.decl.type.args = client2ncopy.decl.type.args
    else:
        client2n_RetExpr = None
        if isinstance(client2n.body.block_items[-1], c_ast.Return):
            client2n_RetExpr = copy.deepcopy(client2n.body.block_items[-1].expr)
            client2n.body.block_items.pop()
        ...
        if client2n.decl.type.args is not None and client1ncopy.decl.type.args is not None:
            client2n.decl.type.args.params.extend(client1ncopy.decl.type.args.params)
        elif client1ncopy.decl.type.args is not None:
            client2n.decl.type.args = client1ncopy.decl.type.args
