...
int client(int n, int n_copy1, int n_copy2, int n_copy3, int n_copy4, int n_copy5, int n_copy6, int n_copy7, int n_copy8, int n_copy9, int n_copy10, int n_copy11, int n_copy12, int n_copy13)
{
  ...
  return (((((((((((((__inlineCall(lib(sum)) == 0) + (__inlineCall(lib(sum_copy1)) == 0)) + (__inlineCall(lib(sum_copy2)) == 0)) + (__inlineCall(lib(sum_copy3)) == 0)) + (__inlineCall(lib(sum_copy4)) == 0)) + (__inlineCall(lib(sum_copy5)) == 0)) + (__inlineCall(lib(sum_copy6)) == 0)) + (__inlineCall(lib(sum_copy7)) == 0)) + (__inlineCall(lib(sum_copy8)) == 0)) + (__inlineCall(lib(sum_copy9)) == 0)) + (__inlineCall(lib(sum_copy10)) == 0)) + (__inlineCall(lib(sum_copy11)) == 0)) + (__inlineCall(lib(sum_copy12)) == 0)) + (__inlineCall(lib(sum_copy13)) == 0);
}
