...
int client(int x, int x_copy1, int x_copy2, int x_copy3, int x_copy4, int x_copy5, int x_copy6, int x_copy7, int x_copy8, int x_copy9, int x_copy10, int x_copy11, int x_copy12, int x_copy13, int x_copy14)
{
  ...
  int ret_copy12;
  int primes_copy12[8] = {2, 3, 5, 7, 11, 13, 17, 19};
  int done_copy12 = 0;
  for (int i_copy12 = 0; i_copy12 < 8; i_copy12++)
  {
    if ((!done_copy12) && (x_copy12 == primes_copy12[i_copy12]))
    {
      ret_copy12 = 1;
      done_copy12 = 1;
    }
  ...
  if (!done_copy12)
    ret_copy12 = __inlineCall(lib(x_copy12, 1));

  int ret_copy13;
  int primes_copy13[8] = {2, 3, 5, 7, 11, 13, 17, 19};
  int done_copy13 = 0;
  for (int i_copy13 = 0; i_copy13 < 8; i_copy13++)
  {
    if ((!done_copy13) && (x_copy13 == primes_copy13[i_copy13]))
    {
      ret_copy13 = 1;
      done_copy13 = 1;
    }
  ...
  if (!done_copy13)
    ret_copy13 = __inlineCall(lib(x_copy13, 1));

  int ret_copy14;
  int primes_copy14[8] = {2, 3, 5, 7, 11, 13, 17, 19};
  int done_copy14 = 0;
  for (int i_copy14 = 0; i_copy14 < 8; i_copy14++)
  {
    if ((!done_copy14) && (x_copy14 == primes_copy14[i_copy14]))
    {
      ret_copy14 = 1;
      done_copy14 = 1;
    }
  ...
  if (!done_copy14)
    ret_copy14 = __inlineCall(lib(x_copy14, 1));
