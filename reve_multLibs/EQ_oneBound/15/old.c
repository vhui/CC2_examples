...
int client(int x, int x_copy1, int x_copy2, int x_copy3, int x_copy4, int x_copy5, int x_copy6, int x_copy7, int x_copy8, int x_copy9, int x_copy10, int x_copy11, int x_copy12, int x_copy13, int x_copy14)
{
  ...
  {
    if (x_copy10 > __inlineCall(lib(x_copy10)))
      ret_copy10 = x_copy10;
    else
  ...
  int ret_copy11;
  if ((x_copy11 < (-100)) || (x_copy11 > 100))
  {
    ret_copy11 = x_copy11;
  }
  else
  {
    if (x_copy11 > __inlineCall(lib(x_copy11)))
      ret_copy11 = x_copy11;
    else
  ...
  int ret_copy12;
  if ((x_copy12 < (-100)) || (x_copy12 > 100))
  {
    ret_copy12 = x_copy12;
  }
  else
  {
    if (x_copy12 > __inlineCall(lib(x_copy12)))
      ret_copy12 = x_copy12;
    else
  ...
  int ret_copy13;
  if ((x_copy13 < (-100)) || (x_copy13 > 100))
  {
    ret_copy13 = x_copy13;
  }
  else
  {
    if (x_copy13 > __inlineCall(lib(x_copy13)))
      ret_copy13 = x_copy13;
    else
      ret_copy13 = __inlineCall(lib(x_copy13));

  }

  int ret_copy14;
  if ((x_copy14 < (-100)) || (x_copy14 > 100))
  {
    ret_copy14 = x_copy14;
  }
  else
  {
    if (x_copy14 > __inlineCall(lib(x_copy14)))
      ret_copy14 = x_copy14;
    else
      ret_copy14 = __inlineCall(lib(x_copy14));
