...
int client(int n, int n_copy1, int n_copy2, int n_copy3, int n_copy4, int n_copy5, int n_copy6, int n_copy7, int n_copy8, int n_copy9, int n_copy10, int n_copy11, int n_copy12, int n_copy13, int n_copy14)
{
  ...
  return (((((((((((((sum + sum_copy1) + sum_copy2) + sum_copy3) + sum_copy4) + sum_copy5) + sum_copy6) + sum_copy7) + sum_copy8) + sum_copy9) + sum_copy10) + sum_copy11) + sum_copy12) + sum_copy13) + sum_copy14;
}
